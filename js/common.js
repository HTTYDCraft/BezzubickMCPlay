...
/* Apple-style reveal: staggered fade+rise for in-view blocks on load,
   same animation when blocks scroll into view. Runs once per element. */
export function initReveal() {
  const els = [...document.querySelectorAll('[data-reveal]:not(.reveal)')];
